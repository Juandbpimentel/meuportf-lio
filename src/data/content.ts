    ...
    endpoints: [
      ...
      },
      {
        ...
        sampleBody: {
          ...
          fileName: "DocumentoPortaFolio",
          data: {
            secoes: [
              {
                componente: "header_corporativo",
                margemInferior: 20,
                empresaNome: "NEXUS TECNOLOGIA GLOBAL",
                documentoTitulo: "RELATÓRIO ANUAL DE PERFORMANCE 2024",
                referencia: "REL-2024-FINAL",
                dataAtual: "08/12/2025",
                logoUrl:
              ...
              },
              {
                ...
                margemInferior: 30,
                tituloSecao: "Resumo do Projeto",
                itens: [
                  { label: "Cliente", valor: "Grupo Financeiro Alpha" },
                  { label: "Gerente Responsável", valor: "Carlos Mendes" },
                  { label: "Status", valor: "Concluído" },
                  { label: "Budget Total", valor: "R$ 1.500.000,00" },
                ],
              },
              {
                componente: "texto",
                ...
                conteudo:
                  "O ano fiscal de 2024 representou um marco histórico para a operação. Atingimos <b>125% da meta</b> estipulada no Q1, com destaque para a redução de custos operacionais (OpEx) e aumento da eficiência energética dos servidores.",
                alinhamento: "justify",
                tamanhoFonte: 12,
              },
              {
                componente: "grafico",
                titulo: "Evolução da Receita Trimestral (em Milhões)",
                config: {
                  type: "bar",
                  data: {
                    labels: ["Q1", "Q2", "Q3", "Q4"],
                ...
                descricao:
                  "O gráfico combina barras (realizado) com linha (meta), demonstrando superação consistente.",
              },
              {
                componente: "texto",
                titulo: "2. Detalhamento Técnico",
                conteudo:
                  "Abaixo apresentamos a distribuição dos incidentes técnicos resolvidos por categoria. Note que a categoria 'Infraestrutura' teve a maior queda após a migração para a nuvem.",
                margemInferior: 10,
              },
              {
                componente: "grafico",
                titulo: "Distribuição de Incidentes (Doughnut Chart)",
                config: {
                  type: "doughnut",
                  data: {
                    labels: ["Software", "Hardware", "Rede", "Segurança"],
                    datasets: [
                      {
                        data: [45, 15, 25, 15],
                        backgroundColor: [
              ...
              },
              {
                componente: "tabela",
                margemInferior: 20,
                titulo: "Top 5 Despesas Operacionais",
                colunas: [
                  "Centro de Custo",
                  "Responsável",
                  "Valor (R$)",
                ...
                linhas: [
                  ["Licenças de Software", "TI Corporativa", "250.000", "35%"],
                  [
                    "Servidores Cloud (AWS)",
                    "Infraestrutura",
                    "180.000",
                    "25%",
                  ],
                  ["Consultoria Externa", "RH", "90.000", "12%"],
                  ["Marketing Digital", "Marketing", "85.000", "11%"],
                  ["Logística", "Operações", "50.000", "7%"],
                ],
              },
              {
                componente: "lista",
                margemInferior: 20,
                titulo: "Próximos Passos (Q1 2025)",
                ordenada: false,
                itens: [
                  "Iniciar migração do banco de dados legado para PostgreSQL.",
                  "Implementar autenticação via MFA para todos os colaboradores.",
                  "Renegociar contratos com fornecedores de hardware.",
                  "Expandir equipe de desenvolvimento (5 novas vagas).",
                ],
              },
              {
                componente: "qrcode",
                titulo: "Autenticidade Digital",
                conteudo: "https://github.com/Juandbpimentel/pdf-microservice",
                legenda:
                  "Aponte a câmera do celular para validar este documento na Blockchain.",
                alinhamento: "center",
              },
              {
                ...
                margemInferior: 0,
                assinantes: [
                  { nome: "Gabriel Alves", cargo: "Chief Technology Officer" },
                  { nome: "Juan Pimentel", cargo: "Diretor de Operações" },
                  {
                    nome: "Auditores Independentes",
                    cargo: "Validação Externa",
                    documento: "CRC 12345/O",
                  },
                ],
              },
            ],
...
export const education = [
  ...
  },
  {
    ...
    institution: "Universidade Federal do Ceará (UFC)",
    degree: {
      pt: "Engenharia da Computação (incompleto)",
      en: "Computer Engineering (incomplete)",
    },
    period: "2019 - 2023",
  },
];
...
export const certifications = [
  {
    enabled: true,
    name: {
      pt: "Fundamentals of Deep Learning — NVIDIA DLI",
      en: "Fundamentals of Deep Learning — NVIDIA DLI",
    },
    issuer: "NVIDIA Deep Learning Institute",
    focus: {
      pt: "Redes neurais, treinamento de modelos e transferência de aprendizado usando PyTorch.",
      en: "Neural networks, model training, and transfer learning with PyTorch.",
    },
  },
  {
    enabled: true,
    name: {
      pt: "Voxy Proficiency Achievement — Intermediário",
      en: "Voxy Proficiency Achievement — Intermediate",
    },
    issuer: "Voxy",
    focus: {
      pt: "Proficiência intermediária em inglês para comunicação técnica e profissional.",
      en: "Intermediate English proficiency for technical and professional communication.",
    },
  },
];
